  ...
  var t = {
      1361: function (t) {
        ...
        t.exports = function (t, i, o, a) {
          ...
          if (t !== i || o !== a)
            for (var c = 0; c < 11; ++c) u[c] = n(0.1 * c, t, o);
          return function (e) {
            return t === i && o === a
              ? e
              : 0 === e
      ...
      906: function (t, e, n) {
        ...
        t.exports = function (t, e, n, v, g, y) {
          ...
          if (I && !w)
            return (
              y || (y = new r()),
              E || l(t) ? i(t, e, n, v, g, y) : o(t, e, b, n, v, g, y)
            );
          if (!(1 & n)) {
        ...
        t.exports = function (t, e, n) {
          ...
          function w() {
            ...
            if (((c = arguments), (s = this), (p = n), r)) {
              if (void 0 === d)
                return (h = t = p), (d = setTimeout(b, e)), v ? E(t) : f;
              if (g) return clearTimeout(d), (d = setTimeout(b, e)), E(p);
            }
      ...
      9516: function (t, e, n) {
        ...
        let _ = function (t) {
          ...
          return "function" == typeof n && n instanceof n && E.call(n) == b;
        };
        var w = n(3485),
          O = { INIT: "@@redux/INIT" };
        function I(t, e, n) {
            ...
            G = l(function (e) {
              function o() {
                var t,
                  ...
                  r = c.length;
                if (r)
                  for (F(o), e = L(), t = r; t--; ) (n = c[t]) && n.render(e);
              }
      ...
      3949: function (t, e, n) {
        ...
        (o.env.safari = /safari/.test(m) && !_ && !w),
          b &&
                        ...
                        (function () {
                          ...
                          d.on(
                            ...
                            d.on(
                              ...
                              (i) => {
                                t(
                                  `input[name="${i.target.name}"]:not(${e})`
                                ).map((e, i) =>
      ...
      4345: function (t, e, n) {
        ...
        r.define(
          ...
          (t.exports = function (t, e) {
            ...
            function y() {
              (n = f.find(p)).length &&
                (n.each(b), c || (E(), r.resize.on(m), r.redraw.on(s.redraw)));
            }
            function E() {
            ...
            function b(e, n) {
              ...
              i.el.off(p),
                ...
                u
                  ...
                  : (i.el.on("swipe" + p, S(i)),
                    ...
                    i.left.on("keydown" + p, I(i, T)),
                    i.right.on("keydown" + p, I(i, A)),
              ...
              s.addClass(h), g || F(e, n), a.removeClass(h), s.removeClass(h);
            }
            function _(t) {
              var e = {};
              (e.crossOver = 0),
            ...
            function O(e, n, r) {
              return function (i) {
                if (n) e.hasFocus[r] = n;
                  ...
                  t.contains(e.el.get(0), i.relatedTarget) ||
                  ((e.hasFocus[r] = n),
            ...
            function S(n) {
              return function (i, a) {
                ...
                if (u && "setting" === i.type) {
                  ...
                  if ((_(n), L(n), null == a.select)) return;
                  return (
                    (c = a.select),
                    (s = null),
                    c === n.slides.length && (y(), L(n)),
                ...
                if (n.nav.has(i.target).length) {
                  var f = t(i.target).index();
                  if (
                    ("click" === i.type && N(n, { index: f }),
                    "keydown" === i.type)
                  )
                    switch (i.keyCode) {
                      case o.ENTER:
                      ...
                      case o.ARROW_RIGHT:
                      case o.ARROW_DOWN:
                        R(n.nav, Math.min(f + 1, n.pages)), i.preventDefault();
                        break;
                      case o.HOME:
            ...
            function N(e, n) {
              ...
              if (
                ...
                u || (h.each(v.intro), E.each(v.outro)),
                n.immediate && !g)
              ) {
                l(h).set(p), x();
                return;
              ...
              if (e.index !== e.previous) {
                if (
                  (u || e.ariaLiveLabel.text(`Slide ${o + 1} of ${i.length}.`),
                  "cross" === m)
                ) {
                ...
                r.infinite && c.x
                  ...
                  : (r.infinite &&
                      e.shifted &&
                      (l(e.shifted).set({ visibility: "", x: f }),
                      (e.shifted = null)),
                    l(e.slides).set({ visibility: "" }).add(I).start({ x: d }));
              }
              function x() {
                (h = t(i[e.index].els)),
                  (E = e.slides.not(h)),
            ...
            function L(e) {
              ...
              var s = e.index;
              s >= n && (s = n - 1), N(e, { immediate: !0, index: s });
            }
            return (
              (s.ready = function () {
                (u = r.env("design")), y();
      ...
      3946: function (t, e, n) {
        ...
        let o = n(7087),
          ...
          P = (t) => ({ type: p, payload: { actionListId: t } }),
          M = () => ({ type: h }),
          j = (t, e) => ({
            type: v,
          ...
          G = (t, e) => ({ type: m, payload: { key: t, value: e } }),
          U = (t) => ({ type: b, payload: { ...t } }),
          V = (t, e) => ({ type: _, payload: { instanceId: t, time: e } }),
          W = (t) => ({ type: w, payload: { instanceId: t } }),
          X = (t, e, n, r) => ({
            type: O,
            payload: {
              elementId: t,
      ...
      1970: function (t, e, n) {
                      ...
                      let h = (t) => {
                          ...
                          ts(l, (o, a, u) => {
                            ...
                            let h = (n = {}) => {
                              ...
                              z(r, l) ||
                                e.dispatch((0, v.eventStateChanged)(u, r));
                            };
                            f.actionTypeId ===
                            p.ActionTypeConsts.GENERAL_CONTINUOUS_ACTION
              ...
              h &&
                x({
                  ...
                  let E = M({ element: l, actionItem: a }),
                    m = S({ element: l, actionItem: a, elementApi: g }, h);
                  tv({
                    store: t,
                    element: l,
                    actionItem: a,
        ...
        function tg(t, e) {
          ...
          let { elementId: n, actionItem: r } = t,
            ...
            { ref: o, refType: a } = i[n] || {};
          a === I && U(o, r, g), e.dispatch((0, v.instanceRemoved)(t.id));
        }
        function ty(t, e, n) {
      ...
      8955: function (t, e, n) {
        ...
        let {
          ...
          V = U(({ element: t, nativeEvent: e }) => t === e.target),
          W = U(({ element: t, nativeEvent: e }) => t.contains(e.target)),
          X = (0, i.default)([V, W]),
          z = (t, e) => {
            if (e) {
          ...
          tp = {
            ...
            [w]: tl(),
            [O]: tf(),
            [P]: { types: "ecommerce-cart-open", handler: q(X, H) },
            [L]: { types: "ecommerce-cart-close", handler: q(X, H) },
            [d]: {
              types: "click",
              handler: q(
                X,
              ...
              handler: (
                ...
                switch (a) {
                  ...
                  default: {
                    ...
                    if (t && !0 !== X({ element: e, nativeEvent: r })) break;
                ...
                return (
                  ...
                  (a !== u.EventBasedOn.ELEMENT ||
                    ...
                    _ !== o.elementHovered) &&
                    ((m = f ? 1 - m : m),
                    t.dispatch((0, s.parameterChanged)(b, m))),
                  {
                    elementHovered: _,
                    clientX: p,
                    clientY: h,
            ...
            [M]: {
              types: "readystatechange IX2_PAGE_UPDATE",
              handler: q(V, (t, e) => (e || H(t), { started: !0 })),
            },
          };
      },
      4609: function (t, e, n) {
        ...
        let r = n(7087),
          ...
          b = (t, e) => {
            ...
            if (n && r) {
              ...
              if (e < 0) return t;
              let n = d(Math.min(Math.max(0, e / b), 1)),
                a = p(m, n, y),
                u = {},
                s = null;
              return (
      ...
      4124: function (t, e, n) {
        ...
        let {
          ...
          tu = (t) => t.trim(),
          tc = Object.freeze({ [tn]: N, [tr]: F, [ti]: L }),
          ts = Object.freeze({
        ...
        function tb({
          ...
          if (_) return [tl.has(_) ? tl.get(_) : tl.set(_, {}).get(_)];
          if (I === s.EventAppliesTo.PAGE) {
            let t = l(b);
            return t ? [t] : [];
          }
          let A = (e?.action?.config?.affectedElements ?? {})[b || w] || {},
            x = !!(A.id || A.selector),
            C = e && f(tm(e.target));
          if (
            (x
              ? ((o = A.limitAffectedElements), (a = C), (u = f(A)))
              : (a = u = f({ id: b, selector: w, selectorGuids: O })),
            e && T)
          ) {
            let t = n && (u || !0 === T) ? [n] : d(C);
            if (u) {
              if (T === D) return d(u).filter((e) => t.some((t) => y(e, t)));
              if (T === P) return d(u).filter((e) => t.some((t) => y(t, e)));
              if (T === j) return d(u).filter((e) => t.some((t) => E(t, e)));
            }
            return t;
          }
        ...
        function tS({ element: t, actionItem: e, elementApi: n }) {
          ...
          switch (e.actionTypeId) {
            ...
            case tt:
              return e.config.fontVariations.reduce(tx, {});
            default: {
          ...
          switch (c) {
              ...
              return (function (t, e, n, r, i, o) {
                ...
                switch (r.actionTypeId) {
                  case te: {
                    ...
                    void 0 !== a &&
                      (e === G && (e = "px"), tG(t, S, o), u(t, S, a + e)),
                      void 0 !== c &&
                        (i === G && (i = "px"), tG(t, R, o), u(t, R, c + i));
                    break;
                  }
                  case J:
                    var c = r.config;
            ...
            case z:
              ...
              if (F.actionTypeId === to) {
                ...
                P(N, k, t === T && h.IS_BROWSER_ENV ? h.FLEX_PREFIXED : t);
              }
              return;
            case H: {
        ...
        function tG(t, e, n) {
          ...
          let { getStyle: i, setStyle: o } = n,
            a = i(t, B);
          if (!a) return void o(t, B, r);
          let u = a.split(U).map(tu);
          -1 === u.indexOf(r) && o(t, B, u.concat(r).join(U));
        }
        function tU(t, e, n) {
          if (!h.IS_BROWSER_ENV) return;
          let r = ts[e];
        ...
        function tV({ store: t, elementApi: e }) {
          ...
          Object.keys(r).forEach((t) => {
            let n = r[t],
              ...
              { actionListId: a } = o,
              u = i[a];
            u && tW({ actionList: u, event: n, elementApi: e });
          }),
        ...
        function tz(t, e, n) {
          ...
          if (o === te) {
            let { config: n } = e;
            n.widthUnit === G && r(t, S, ""), n.heightUnit === G && r(t, R, "");
          }
          i(t, B) && t$({ effect: tU, actionTypeId: o, elementApi: n })(t);
        }
        let t$ =
        ...
        function t1(t) {
          ...
          if (t.pluginElement && t.objectId)
            return t.pluginElement + W + t.objectId;
        ...
        Webflow.require("ix2").init({
          events: {
            e: {
              ...
              target: {
                id: "67eae44f25ba978e9a0cc58c|ee0814e7-c132-8448-07b9-683bceba777f",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
              },
              targets: [
            ...
            "e-3": {
              ...
              mediaQueries: ["main", "medium", "small", "tiny"],
              target: {
                id: "67eae44f25ba978e9a0cc58c|48f882e3-c908-e35f-9599-fb2d748df193",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
              },
              targets: [
            ...
            "e-5": {
              ...
              mediaQueries: ["main", "medium", "small", "tiny"],
              target: {
                id: "67eae44f25ba978e9a0cc58c|fabe720b-4e90-5908-9320-7cb78105a258",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
              },
              targets: [
            ...
            "e-7": {
              ...
              mediaQueries: ["main", "medium", "small", "tiny"],
              target: {
                id: "67eae44f25ba978e9a0cc58c|0e3287f6-17d7-43bc-06d4-7e1c17d5f5a9",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
              },
              targets: [
            ...
            "e-9": {
              ...
              mediaQueries: ["main", "medium", "small", "tiny"],
              target: {
                id: "67eae44f25ba978e9a0cc58c|10af5a97-0b1d-da6b-c0f4-f6e0fef40a40",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
              },
              targets: [
            ...
            "e-11": {
              ...
              mediaQueries: ["main", "medium", "small", "tiny"],
              target: {
                id: "67eae44f25ba978e9a0cc58c|e53a0057-d7f5-bf43-5bd2-8d8981d2dd06",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
              },
              targets: [
